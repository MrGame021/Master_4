...
<body>
    <div class="corpoP">
        ...
        <form action="back_cadastro.php" method="post" enctype="multipart/form-data">
            ...
            <small>Foto</small><input type="file" name="foto" accept="image/*">
        ...
        <label>
            Já tem uma conta? <a href="sist_login.php">login</a><br>
